...
$url = BASE_URL ."/order/".$order_number;
$base = BASE_URL;
      ...
      ">
        <tr>
          <td class="inner" style="padding:28px;">
            ...
            <!-- Title -->
            <h1 style="margin:0 0 8px; font-family:Arial,Helvetica,sans-serif; font-size:24px; font-weight:800; line-height:1.25; color:#f5f7fb;">
              Purchase Receipt
            </h1>
            <p style="margin:0 0 16px; font:15px/1.6 Arial,Helvetica,sans-serif; color:#dfe3ef;">
              Hello,<br>We inform you that we have received your order.
            </p>
